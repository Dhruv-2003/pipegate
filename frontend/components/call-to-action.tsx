      ...
      <div className="text-center mb-12">
        ...
        >
          ...
          >
            ...
            >
              Try out beta release
            </a>
          </Button>
        </motion.div>
      </div>
      <Card className="bg-card/50 backdrop-blur-md mx-auto max-w-md hover:shadow-lg transition-shadow duration-300">
        <CardHeader>
          ...
          <CardDescription>Open-source API monetization</CardDescription>
        </CardHeader>
