 ...
 * @returns {Promise<any>}
 */
module.exports.verify_channel_no_state = function (
  config_json,
  current_channel_json,
  message,
  signature,
  payment_channel_json,
  payment_amount,
  timestamp,
  body_bytes
) {
  ...
  var ptr1 = isLikeNone(current_channel_json)
    ? 0
    : passStringToWasm0(
        current_channel_json,
        wasm.__wbindgen_malloc,
  ...
  const ret = wasm.verify_channel_no_state(
    ptr0,
    len0,
    ptr1,
    len1,
 ...
 * @returns {Promise<any>}
 */
module.exports.verify_onetime_payment_tx = function (
  ontime_payment_config_json,
  signature,
  tx_hash
) {
  const ptr0 = passStringToWasm0(
  ...
  const len2 = WASM_VECTOR_LEN;
  const ret = wasm.verify_onetime_payment_tx(
    ptr0,
    len0,
    ptr1,
    len1,
 ...
 * @returns {Promise<any>}
 */
module.exports.verify_stream_tx = function (
  stream_config_json,
  signature,
  sender
) {
 ...
 * @returns {Promise<any>}
 */
module.exports.close_and_withdraw_channel = function (
  rpc_url,
  private_key,
  signature,
  payment_channel_json,
  ...
  const len4 = WASM_VECTOR_LEN;
  const ret = wasm.close_and_withdraw_channel(
    ptr0,
    len0,
    ptr1,
    len1,
...
const PaymentChannelVerifierFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_paymentchannelverifier_free(ptr >>> 0, 1)
      );
...
class PaymentChannelVerifier {
  ...
  verify_request(
    ...
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.paymentchannelverifier_verify_request(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
...
const StreamVerifierFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_streamverifier_free(ptr >>> 0, 1)
      );
...
class StreamVerifier {
  ...
  verify_request(signature, sender) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.streamverifier_verify_request(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
...
module.exports.__wbg_arrayBuffer_d0ca2ad8bda0039b = function () {
...
module.exports.__wbg_newwithbyteoffsetandlength_ba35896968751d91 = function (
  arg0,
  arg1,
  arg2
) {
...
module.exports.__wbg_static_accessor_GLOBAL_THIS_1a6eb482d12c9bfb =
  function () {
...
module.exports.__wbindgen_closure_wrapper1288 = function (arg0, arg1, arg2) {
...
const path = require("path").join(__dirname, "../../wasm/pipegate_bg.wasm");
